            ...
            <div  id="tab-attribute">
                ...
                <?php foreach ($languages as $language) { ?>
                    <div id="tab-attribute_language<?php echo $language['language_id'];?>">
                            <div class="form-group form-inline collapse <?php if (in_array("fs_tab-duty_hideFilter" . $language['language_id'], $filter_settings)) { echo 'in'; } ?>" id="tab-attribute_filter<?php echo $language['language_id']; ?>">
                        ...
                        <div id="options_attribute_group_tree<?php echo $language['language_id']; ?>" title="<?php echo $text_Options[$language['language_id']]; ?>">
                            ...
                            <label class="checkbox-inline" for="lazyLoad<?php echo $language['language_id']; ?>">
                                <input type="checkbox" id="lazyLoad_attribute_group_tree<?php echo $language['language_id']; ?>" <?php echo ($attributico_lazyload == '1' ? 'checked="checked"' : ''); ?>> <b><?php echo $text_lazyLoad[$language['language_id']]; ?></b>
                            </label>
                        </div>
                    </div>
                <?php } ?>
                ...
                <?php foreach ($languages as $language) { ?>
                    <div id="tab-duty_language<?php echo $language['language_id'];?>">
                            ...
                            <div id="options_duty_attribute_tree<?php echo $language['language_id']; ?>" title="<?php echo $text_Options[$language['language_id']]; ?>">
                                ...
                                <br>
                                <label class="checkbox-inline" for="lazyLoad<?php echo $language['language_id']; ?>">
                                    <input type="checkbox" id="lazyLoad_duty_attribute_tree<?php echo $language['language_id']; ?>" <?php echo ($attributico_lazyload == '1' ? 'checked="checked"' : ''); ?>> <b><?php echo $text_lazyLoad[$language['language_id']]; ?></b>
                                </label>
                            </div>
                        </div>
                    <?php } ?>
            ...
            <div id="tab-category">
                ...
                <?php foreach ($languages as $language) { ?>
                    <div id="tab-category_language<?php echo $language['language_id'];?>">
                            <div class="form-group form-inline collapse <?php if (in_array("fs_tab-duty_hideFilter" . $language['language_id'], $filter_settings)) { echo 'in'; } ?>" id="tab-category_filter<?php echo $language['language_id']; ?>">
                                ...
                                <tr>
                                    <td class="left" style="width: 50%;">
                                        ...
                                        <div id="options_attribute_tree<?php echo $language['language_id']; ?>" title="<?php echo $text_Options[$language['language_id']]; ?>">
                                            ...
                                            <br>
                                            <label class="checkbox-inline" for="lazyLoad<?php echo $language['language_id']; ?>">
                                                <input type="checkbox" id="lazyLoad_attribute_tree<?php echo $language['language_id']; ?>" <?php echo ($attributico_lazyload == '1' ? 'checked="checked"' : ''); ?>> <b><?php echo $text_lazyLoad[$language['language_id']]; ?></b>
                                            </label>
                                        </div>
                                    </td>
                                </tr>
            ...
            <div id="tab-products">
                ...
                <?php foreach ($languages as $language) { ?>
                    <div id="tab-products_language<?php echo $language['language_id'];?>">
                            <div class="form-group form-inline collapse <?php if (in_array("fs_tab-duty_hideFilter" . $language['language_id'], $filter_settings)) { echo 'in'; } ?>" id="tab-products_filter<?php echo $language['language_id']; ?>">
                                ...
                                <tr>
                                    <td class="left" style="width: 50%;">
                                        ...
                                        <div id="options_attribute_product_tree<?php echo $language['language_id']; ?>" title="<?php echo $text_Options[$language['language_id']]; ?>">
                                            ...
                                            <br>
                                            <label class="checkbox-inline" for="lazyLoad<?php echo $language['language_id']; ?>">
                                                <input type="checkbox" id="lazyLoad_attribute_product_tree<?php echo $language['language_id']; ?>" <?php echo ($attributico_lazyload == '1' ? 'checked="checked"' : ''); ?>> <b><?php echo $text_lazyLoad[$language['language_id']]; ?></b>
                                            </label>
                                        </div>
                                    </td>
                                    <td class="left">
			    ...
			    <td class="right"><?php echo $head_command; ?></td>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td class= "right"><div class="ajax-loader"><img class= "loader-img" src="view/javascript/fancytree/skin-win7/loading.gif" style="display:none;"/></div>
                ...
                <div class="vtabs-content" id="tab-detached">
                    <div class="alert alert-danger warning" role="alert"> <?php echo $alert_backup; ?> </div>
                     <table class="list table">
                        ...
                        <tbody>
                          <tr>
                            <td> <div id="group_check_tree1" name="group_check_tree1" class="options"></div></td>
                ...
                <div class="vtabs-content" id="tab-deduplicate">
                    <div class="alert alert-danger warning" role="alert"> <?php echo $alert_backup; ?> </div>
                     <table class="list table">
                        ...
                        <tbody>
                          <tr>
                            <td> <div id="group_check_tree2" name="group_check_tree2" class="options"></div></td>
                    ...
                    <div class="alert alert-danger warning" role="alert"> <?php echo $alert_backup; ?> </div>
                     <table class="list table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td> <div id="category_check_tree1" name="category_check_tree1" class="options"></div></td>
