...
<div id="content">
    ...
    <div class="container-fluid">
        <?php if ($error_warning) { ?>
            <div id="error_warning" class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> <?php echo $error_warning; ?>
        ...
        <div class="panel panel-default alert-before">
            ...
            <div class="panel-body">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="left">
                                                            ...
                                                            <div id="options_product_tree<?php echo $language['language_id']; ?>" title="<?php echo $text_Options[$language['language_id']]; ?>">
                                                                ...
                                                                <br>
                                                                <label class="checkbox-inline" for="lazyLoad<?php echo $language['language_id']; ?>">
                                                                    <input type="checkbox" id="lazyLoad_product_attribute_tree<?php echo $language['language_id']; ?>" <?php echo ($attributico_lazyload == '1' ? 'checked="checked"' : ''); ?>> <b><?php echo $text_lazyLoad[$language['language_id']]; ?></b>
                                                                </label>
                                                            </div>
                                                        </td>
                                                    </tr>
				...
				<div class="col-lg-10 col-md-9" style="border-left: 1px solid #eee;" id="column-2">
                                    <div class="alert alert-danger" role="alert"> <?php echo $alert_backup; ?> </div>
                                    <div class="tab-content">
						...
						<table class="table table-bordered">
						  ...
						  <thead>
							<tr>
							  <th><label class="control-label"><span data-toggle="tooltip" title="<?php echo $help_defrag_options; ?>"><?php echo $head_settings; ?></span></label></th>
							  <th><?php echo $head_command; ?></th>
                                                          <th><?php echo $head_status; ?></th>
							</tr>
						  </thead>
						...
						<table class="table table-bordered">
						  ...
						  <thead>
							<tr>
							  <th><label class="control-label"><span data-toggle="tooltip" title="<?php echo $help_group_options; ?>"><?php echo $head_settings; ?></span></label></th>
							  <th><?php echo $head_command; ?></th>
                                                          <th><?php echo $head_status; ?></th>
							</tr>
						  </thead>
						...
						<table class="table table-bordered">
						  ...
						  <thead>
							<tr>
							  <th><label class="control-label"><span data-toggle="tooltip" title="<?php echo $help_categories_options; ?>"><?php echo $head_settings; ?></span></label></th>
							  <th><?php echo $head_command; ?></th>
                                                          <th><?php echo $head_status; ?></th>
							</tr>
						  </thead>
						...
						<table class="table table-bordered">
						  ...
						  <tbody>
							<tr>
							  <th style="text-align: center;"> <?php echo $help_nosettings; ?> </th>
							  <td><button type="button" onclick=" return tools('cache')" data-toggle="tooltip" title="<?php echo $button_play; ?>" class="btn btn-warning"><i class="fa fa-play"></i></button></td>
                                                          <td><div class="ajax-loader"><img class= "loader-img" src="view/javascript/fancytree/skin-win7/loading.gif" style="display:none;"/></div>
                                                              <div class="task-complete"><img class= "complete-img" src="view/javascript/fancytree/skin-custom/accept.png" style="display:none;"/></div>
                                                           </td>
                                                        </tr>
