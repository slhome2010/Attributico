...
class ModelCatalogAttributicoTools extends Model
{
    ...
    public function sorting() {
        ...
        $this->db->query("UPDATE " . DB_PREFIX . "attribute a INNER JOIN (SELECT t1.attribute_id FROM  " . DB_PREFIX . "attribute t1 LEFT JOIN  " . DB_PREFIX . "attribute_group t2 ON t1.attribute_group_id = t2.attribute_group_id ORDER BY t2.sort_order ASC) AS g ON a.attribute_id = g.attribute_id SET a.sort_order = @num :=@num+1");
        return $this->db->countAffected();
    }
